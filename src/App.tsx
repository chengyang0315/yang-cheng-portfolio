...
type ToolName = 'Doubao' | 'Kimi' | 'DeepSeek' | 'ChatGPT' | 'Gemini' | 'Claude' | 'Grok';
...
const aiTimeline: AiTimelineItem[] = [
  ...
  { stage: 'TURNING POINT', title: 'The interview', keywords: 'Accounting or tech? · All in on AI', text: 'A part-time accounting interview forced a question I had avoided: accounting or technology? My hesitant answer felt dishonest, so I spent the next few days going all in on AI learning.' },
  { stage: 'THE BARRIER FALLS', title: 'Vibe coding', toolNames: ['Gemini', 'Claude', 'Grok'], keywords: 'Tokens · Google AI Studio', text: 'I resisted vibe coding because it contained the word “coding”. Free access to Google AI Studio lowered the barrier, and I learned that product judgement mattered as much as typing every line by hand.' },
